...
mixin _$ServiceModel {
 ...
 String get id; String get name; String get description; double get price; int get duration; bool? get isActive; String? get imageUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,price,duration,isActive,imageUrl);

@override
String toString() {
  return 'ServiceModel(id: $id, name: $name, description: $description, price: $price, duration: $duration, isActive: $isActive, imageUrl: $imageUrl)';
}
...
@useResult
$Res call({
 String id, String name, String description, double price, int duration, bool? isActive, String? imageUrl
});
...
/// Create a copy of ServiceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = null,Object? price = null,Object? duration = null,Object? isActive = freezed,Object? imageUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String description,  double price,  int duration,  bool? isActive,  String? imageUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServiceModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.price,_that.duration,_that.isActive,_that.imageUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String description,  double price,  int duration,  bool? isActive,  String? imageUrl)  $default,) {final _that = this;
switch (_that) {
case _ServiceModel():
return $default(_that.id,_that.name,_that.description,_that.price,_that.duration,_that.isActive,_that.imageUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String description,  double price,  int duration,  bool? isActive,  String? imageUrl)?  $default,) {final _that = this;
switch (_that) {
case _ServiceModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.price,_that.duration,_that.isActive,_that.imageUrl);case _:
  return null;
...
class _ServiceModel implements ServiceModel {
  const _ServiceModel({required this.id, required this.name, required this.description, required this.price, required this.duration, this.isActive, this.imageUrl});
...
/// Create a copy of ServiceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? price = null,Object? duration = null,Object? isActive = freezed,Object? imageUrl = freezed,}) {
